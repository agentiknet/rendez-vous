...
// BRIEF 46: the probe lives in src/service/probe.ts so the delivery engine
// (tool path, boot replay) applies the SAME rule from the SAME code — this
// module re-exports it because every existing importer of the fanout reader
// reads the probe from here.
export { probeArtifactUrl, type ArtifactProbe } from "../service/probe.ts"
import { probeArtifactUrl, type ArtifactProbe } from "../service/probe.ts"
